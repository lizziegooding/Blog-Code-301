...
articleView.initNewArticlePage = function() {
  ...
  $('.tab-content').show();
  // DONE: The new articles we create will be copy/pasted into our source data file. Set up this "export" functionality. We can hide it for now, and show it once we have data to export.
...
articleView.create = function() {
  ...
  console.log('about to populate article json');
